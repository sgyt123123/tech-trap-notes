...
const ResistanceVisual: React.FC = () => (
  <div className="bg-slate-900/70 rounded-xl p-4 lg:p-5 border border-slate-600/80 mb-4 flex flex-col items-center relative overflow-visible">
    <div className="w-full flex justify-between items-center text-xs font-bold text-slate-100 tracking-[0.16em] mb-4 z-10">
      <span>阈值突破</span>
    </div>
      ...
      <svg className="w-full h-full overflow-visible" viewBox="-16 -24 332 350" preserveAspectRatio="xMidYMid meet">
        ...
        <foreignObject x="70" y="-14" width="160" height="128">
          <div className="flex flex-col items-center animate-in zoom-in duration-700">
            <div className="bg-red-500/10 p-3 rounded-full border border-red-500/50 shadow-[0_0_25px_rgba(239,68,68,0.4)] mb-2 relative">
            ...
            <div className="bg-slate-950/90 border border-red-900/60 px-3 py-1 rounded text-center backdrop-blur-sm">
              <div className="text-red-300 font-black text-[13px] tracking-wider leading-tight">卢德式反抗</div>
              <div className="text-xs text-red-300/80 font-mono leading-tight">生存反抗</div>
            </div>
          </div>
        </foreignObject>
    ...
    <div className="w-full max-w-[95%] bg-slate-950/85 p-3 rounded-xl border border-slate-600/80 shadow-xl backdrop-blur-md flex flex-wrap items-center justify-center gap-3 relative z-20 mt-2">
      <div className="flex flex-col items-center">
        <span className="text-[11px] text-red-300 font-bold tracking-wider mb-0.5">压力</span>
      ...
      <div className="flex flex-col items-center opacity-60">
        <span className="text-[11px] text-slate-300 font-bold tracking-wider mb-0.5">缓冲</span>
      ...
      <div className="bg-red-900/30 px-4 py-2 rounded-lg shadow-lg flex items-center gap-2 border border-red-500/30 transition-colors">
        <Flame size={16} className="text-red-500 fill-red-500/50" />
